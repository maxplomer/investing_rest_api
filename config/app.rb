...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'investing-rest-api.com'
  config.app_name = 'Investing_rest_api'
  config.mailer.from = 'Investing_rest_api <no-reply@investing-rest-api.com>'
  ...
  #
  config.app_secret = 'Bq93osEi4PJOdC-uqmiYPnpS0jn2p2teN_zWPyqV4lVdBrD-y7yfEpwI7KiwUPasR6M'
